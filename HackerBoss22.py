# decompile by Tech Hacker
# source code by Tech Boss
...
def reg():
    ...
    print ''
    print ''
    print '\x1b[1;92m  [Connected With HackerBoss Servers]'
    print ''
...
def reg2():
    ...
    print ''
    print '\x1b[1;96m '
    print ' \xe2\x80\xa2 THIS TOOL IS COMPLETELY CODED BY HACKER BOSS \xe2\x80\xa2 '
    time.sleep(5)
    login()
...
def menu():
    ...
    print ''
    print ' [1] START'
    print ' [2] FOLLOW HackerBoss ON FB '
...
def menu_option():
    ...
    if select == '1':
        ...
        os.system('xdg-open https://www.facebook.com/10223613883047134')
        menu()
    else:
        print ''
